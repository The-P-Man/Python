...
def computer(code, value=1):
    ...
    if opcode in ('1', '2'):
        ...
        a, b, c = code[1:4]
        print(a, b, c)
        A, B, C = list(zip([code[a%n], code[b%n], code[c%n]], (a, b, c)))
        print(A, B, C, i, j, k)
...
# def computer(code, mode=0, param=0):
